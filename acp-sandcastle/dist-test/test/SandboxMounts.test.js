...
test('buildSandboxMounts adds Linux git overrides for docker worktrees', () => {
    ...
    try {
        ...
        assert.equal(fs.readFileSync(gitOverride.hostPath, 'utf8'), 'gitdir: /.sandcastle-parent-git/worktrees/sandcastle-acp-vibe-123\n');
    }
    finally {
        fs.rmSync(repo, { recursive: true, force: true });
    }
...
//# sourceMappingURL=SandboxMounts.test.js.map