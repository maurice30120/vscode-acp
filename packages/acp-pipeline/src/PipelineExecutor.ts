...
import type { PipelinePrimitiveDefinition, PipelineSideEffects } from './PipelineTypes';
import {
...
export type PipelineAgentRunner = (input: PipelineAgentRunInput) => Promise<PipelineStepRunResult>;
...
export class PipelineExecutor {
  ...
  async runStep(
    ...
    if (!this.dependencies.runAgent) {
      throw new Error('PipelineExecutor requires runAgent or runAcpAgent dependency.');
    }
