...
/**
 * Gere les demandes de permission ACP emises par les agents.
 * Affiche un QuickPick VS Code afin que l'utilisateur choisisse une option proposee par l'agent.
 */
export class PermissionHandler {
  async requestPermission(params: RequestPermissionRequest): Promise<RequestPermissionResponse> {
    ...
    // Auto-approbation : selectionne la premiere option de type allow
    ...
    // Construit les items QuickPick a partir des options fournies par l'agent
