...
import type { ModelOption, ModeOption, PersistedWebviewState } from './chatTypes';
...
export function App(): JSX.Element {
  ...
  function selectSlashCommand(command: { name: string; input?: { hint?: string } | null } | undefined): void {
    if (!command) {
      return;
    }
